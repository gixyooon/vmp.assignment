...
# demo video linkage : https://youtu.be/p4lmq3JqGP8
        ...
        pygame.display.set_caption("20221011_KIMJIYUN_Shmup!")
        ...
        bullet_img = pygame.image.load(path.join(img_dir,"beams.png")).convert()
        bullet_img = pygame.transform.scale(bullet_img, (30, 30))
        meteor_images = []
        meteor_list = ['meteor-01-l.png', 'meteor-01-m.png', 'meteor-01-s.png',
                       'meteor-02-l.png', 'meteor-02-m.png', 'meteor-02-s.png',
                       'meteor-02-xl.png']
        ...
        shoot_sound = pygame.mixer.Sound(path.join(snd_dir, 'laserpew.ogg'))
        expl_sounds = []
